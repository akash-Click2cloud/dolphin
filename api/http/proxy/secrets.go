...
const (
	// ErrDockerSecretIdentifierNotFound defines an error raised when dockm is unable to find a secret identifier
	ErrDockerSecretIdentifierNotFound = dockm.Error("Docker secret identifier not found")
	secretIdentifier                  = "ID"
)
