...
const (
	// ErrDockerNetworkIdentifierNotFound defines an error raised when dockm is unable to find a network identifier
	ErrDockerNetworkIdentifierNotFound = dockm.Error("Docker network identifier not found")
